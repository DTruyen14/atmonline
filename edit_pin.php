...
<div class="container">
        ...
        <form method="post">
	        ...
	        <div style="text-align: center;"><input type="submit" name="edit" class="submit" value="Đổi Pin" 
            formenctype="multipart/form-data" onClick="if(confirm('Thực hiện đổi mã PIN?')) 
    return true; else return false;"><div class="vantay"><img src="img/vantay.png" style="width: 45px;height: 45px;padding-top: 10px;"></div></div>
